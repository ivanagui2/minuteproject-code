...
public class EntityValidationConvention extends ModelConvention {
	...
	public void apply(Table table) {
		...
		if (collect.size()==2) {
			...
			if (type.equals("first-field-less-than-second-field")) {
				etfc.setOperand("LESS_THAN");
			}
	...
	protected boolean isValid() {
		return firstFieldPattern!=null && secondFieldPattern!=null && fieldPatternType!=null && type!=null;
	}
