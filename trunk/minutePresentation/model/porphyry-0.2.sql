...
-- -----------------------------------------------------
-- Data for table `porphyry`.`ADMIN_ENVIRONMENT`
-- -----------------------------------------------------
START TRANSACTION;
USE `porphyry`;
INSERT INTO `porphyry`.`ADMIN_ENVIRONMENT` (`ID`, `NAME`, `DESCRIPTION`, `DISPLAY_ORDER`) VALUES (1, 'DEV', 'development', 1);
INSERT INTO `porphyry`.`ADMIN_ENVIRONMENT` (`ID`, `NAME`, `DESCRIPTION`, `DISPLAY_ORDER`) VALUES (2, 'TST', 'test', 2);
INSERT INTO `porphyry`.`ADMIN_ENVIRONMENT` (`ID`, `NAME`, `DESCRIPTION`, `DISPLAY_ORDER`) VALUES (3, 'ACC', 'acceptance', 3);
INSERT INTO `porphyry`.`ADMIN_ENVIRONMENT` (`ID`, `NAME`, `DESCRIPTION`, `DISPLAY_ORDER`) VALUES (4, 'PRD', 'production', 4);

COMMIT;

-- -----------------------------------------------------
-- Data for table `porphyry`.`ADMIN_PROJECT`
-- -----------------------------------------------------
START TRANSACTION;
USE `porphyry`;
INSERT INTO `porphyry`.`ADMIN_PROJECT` (`ID`, `NAME`) VALUES (1, 'Openxava');
INSERT INTO `porphyry`.`ADMIN_PROJECT` (`ID`, `NAME`) VALUES (2, 'JOOQ');
INSERT INTO `porphyry`.`ADMIN_PROJECT` (`ID`, `NAME`) VALUES (3, 'Minute Project');

COMMIT;

-- -----------------------------------------------------
-- Data for table `porphyry`.`ADMIN_APPLICATION`
-- -----------------------------------------------------
START TRANSACTION;
USE `porphyry`;
INSERT INTO `porphyry`.`ADMIN_APPLICATION` (`ID`, `NAME`, `DESCRIPTION`, `PROJECT_ID`) VALUES (1, 'OpenXava Workspace', 'Openxava solution workspace', 1);
INSERT INTO `porphyry`.`ADMIN_APPLICATION` (`ID`, `NAME`, `DESCRIPTION`, `PROJECT_ID`) VALUES (2, 'Jooq embedded', 'JOOQ generic part', 2);
INSERT INTO `porphyry`.`ADMIN_APPLICATION` (`ID`, `NAME`, `DESCRIPTION`, `PROJECT_ID`) VALUES (3, 'MinuteProject 4 Openxava', 'reverse-engineering for MP', 3);
INSERT INTO `porphyry`.`ADMIN_APPLICATION` (`ID`, `NAME`, `DESCRIPTION`, `PROJECT_ID`) VALUES (4, 'MinuteProject 4 JOOQ', 'reverse-engineering solution targeting JOOQ artifacts', 3);

COMMIT;

-- -----------------------------------------------------
-- Data for table `porphyry`.`SEC_USER`
-- -----------------------------------------------------
START TRANSACTION;
USE `porphyry`;
INSERT INTO `porphyry`.`SEC_USER` (`ID`, `IDENTIFIER`, `ACTIVE`, `EMAIL`) VALUES (1, 'admin', 1, 'admin@test.com');
INSERT INTO `porphyry`.`SEC_USER` (`ID`, `IDENTIFIER`, `ACTIVE`, `EMAIL`) VALUES (2, 'releaser', 1, 'releaser@test.com');
INSERT INTO `porphyry`.`SEC_USER` (`ID`, `IDENTIFIER`, `ACTIVE`, `EMAIL`) VALUES (3, 'validator', 1, 'validator@test.com');
INSERT INTO `porphyry`.`SEC_USER` (`ID`, `IDENTIFIER`, `ACTIVE`, `EMAIL`) VALUES (4, 'reviewer', 1, 'reviewer@test.com');

COMMIT;

-- -----------------------------------------------------
-- Data for table `porphyry`.`SEC_ROLE`
-- -----------------------------------------------------
START TRANSACTION;
USE `porphyry`;
INSERT INTO `porphyry`.`SEC_ROLE` (`ID`, `ROLE`) VALUES (1, 'ADMIN');
INSERT INTO `porphyry`.`SEC_ROLE` (`ID`, `ROLE`) VALUES (2, 'RELEASER');
INSERT INTO `porphyry`.`SEC_ROLE` (`ID`, `ROLE`) VALUES (3, 'RELEASE_VALIDATOR');
INSERT INTO `porphyry`.`SEC_ROLE` (`ID`, `ROLE`) VALUES (4, 'REVIEWER');

COMMIT;

-- -----------------------------------------------------
-- Data for table `porphyry`.`SEC_USER_ROLE`
-- -----------------------------------------------------
START TRANSACTION;
USE `porphyry`;
INSERT INTO `porphyry`.`SEC_USER_ROLE` (`SEC_USER_ID`, `SEC_ROLE_ID`) VALUES (1, 1);
INSERT INTO `porphyry`.`SEC_USER_ROLE` (`SEC_USER_ID`, `SEC_ROLE_ID`) VALUES (2, 2);
INSERT INTO `porphyry`.`SEC_USER_ROLE` (`SEC_USER_ID`, `SEC_ROLE_ID`) VALUES (3, 3);
INSERT INTO `porphyry`.`SEC_USER_ROLE` (`SEC_USER_ID`, `SEC_ROLE_ID`) VALUES (4, 4);
